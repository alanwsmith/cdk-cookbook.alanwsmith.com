...
class ApiGatewayWebsocketsCloudfrontS3ChatPrototypeStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        web_socket_api = apiv2a.WebSocketApi(
            self, 
            "cdkApiGatewayWebsocketsCloudfrontS3ChatPrototypeAPI"
        )

        apiv2a.WebSocketStage(
            self, 
            "cdkApiGatewayWebsocketsCloudfrontS3ChatPrototypeStage",
        ...
        message_handler = lambda_.Function(
            self, 
            "cdkApiGatewayWebsocketsCloudfrontS3ChatPrototypeMessageFunciton",
        ...
        web_socket_api.add_route(
            ...
            integration=apiv2ai.WebSocketLambdaIntegration(
                "cdkApiGatewayWebsocketsCloudfrontS3ChatPrototypeMessageIntegration",
                message_handler
            )
        )
